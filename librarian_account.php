...
<body>
	...
	<div id = "my_button">
		<p><a href = "librarian_updatedetails.php" class = "button"><label>Edit Details</label></a></p>
		<p><a href = "librarian_updatepassword.php" class = "button"><label>Edit Password</label></a></p>
	</div>
